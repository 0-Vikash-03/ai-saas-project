    ...
    <div className="min-h-screen bg-gray-50 px-6 md:px-16 py-10">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-md border p-6 h-[78vh] flex flex-col"
        >
          {/* HEADER */}
          <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <select
              ...
              className="border rounded-lg p-1.5 text-xs bg-gray-50 text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
        ...
        >
          {/* OUTPUT BOX */}
          <div
            className="bg-white rounded-xl shadow-md border p-6 overflow-y-auto"
            style={{ minHeight: "300px", maxHeight: "42vh" }}
          >
            {script ? (
